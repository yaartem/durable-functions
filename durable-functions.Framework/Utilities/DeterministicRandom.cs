...
**
===========================================================*/
namespace Utilities.Deterministic
{
    ...
    public class DeterministicRandom
    {
        ...
        **Exceptions: None.
        ...
        public virtual int Next(int minValue, int maxValue)
        {
            ...
            {
                throw new System.ArgumentOutOfRangeException(nameof(minValue), minValue, "value is out of range");
            }
        ...
        **Exceptions: None.
        ...
        public virtual int Next(int maxValue)
        {
            if (maxValue < 0)
            {
                throw new System.ArgumentOutOfRangeException(nameof(maxValue), maxValue, "value is out of range");
            }
            Contract.EndContractBlock();
